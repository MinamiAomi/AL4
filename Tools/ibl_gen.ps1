...
.\cmft.exe --input $input_path --filter radiance --clVendor nvidia --deviceType gpu --lightingModel blinn --dstFaceSize $size --mipCount 11 --outputNum 1 --output0 "${output_name}_radiance" --output0params dds,rgba16f,cubemap
