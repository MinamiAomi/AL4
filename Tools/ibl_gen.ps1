...
.\cmft.exe --input $input_path --filter irradiance --dstFaceSize $size --outputNum 1 --output0 "${output_name}_irradiance" --output0params dds,rgba16f,cubemap
.\cmft.exe --input $input_path --filter radiance --useOpenCL true --dstFaceSize $size --outputNum 1 --output0 "${output_name}_radiance" --output0params dds,rgba16f,cubemap
